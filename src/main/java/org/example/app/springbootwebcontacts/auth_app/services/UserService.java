package org.example.app.springbootwebcontacts.auth_app.services;


import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import org.example.app.springbootwebcontacts.apps_dto.ResponseDataDTO;
import org.example.app.springbootwebcontacts.auth_app.utils.ERole;
import org.example.app.springbootwebcontacts.contacts_app.service.ContactsService;
import org.example.app.springbootwebcontacts.exceptions.custome_exception.ValidationException;
import org.example.app.springbootwebcontacts.validate.auth_form.sign_up.SignUpFormDTO;
...
import org.example.app.springbootwebcontacts.validate.auth_form.sign_up.ValidateSignUpFormProcessing;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.security.crypto.password.PasswordEncoder;
import org.springframework.stereotype.Service;
import org.example.app.springbootwebcontacts.auth_app.repository.UserRepository;
...
public class UserService {
    ...
    public ResponseDataDTO<User> saveUser(SignUpFormDTO form) {
        ...
        try{
            ...
            if (role.isEmpty()) {
                roleService.createUserRole(ERole.ROLE_USER.getRoleName());
                role = roleService.getRoleByName(ERole.ROLE_USER.getRoleName());
            }
