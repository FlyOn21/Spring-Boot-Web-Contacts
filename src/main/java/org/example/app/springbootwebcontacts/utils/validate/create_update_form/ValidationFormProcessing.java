...
import org.example.app.springbootwebcontacts.utils.validate.Validator;
import org.example.app.springbootwebcontacts.utils.validate.enums.EValidateCustomer;
...
public class ValidationFormProcessing {
    ...
    private final CheckCustomerEntity repository;
    private Long id;


    public ValidationFormProcessing(CheckCustomerEntity repository, FormDataForValidate data) {
    ...
    public ValidationFormProcessing(CheckCustomerEntity repository, FormDataForValidate data, Long id) {
        this.repository = repository;
        this.id = id;
        this.data = data;
        validateFirstName(data.getFirstName());
